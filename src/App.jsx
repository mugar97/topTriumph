      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-white mt-2 text-sm">
            {vehicles.length > 0 ? `Showing ${filteredVehicles.length} of ${vehicles.length} vehicles` : 'Or upload your own CSV with vehicle data'}
          </p>
        </div>
        ...
        {vehicles.length > 0 && (
          <div className="mb-8">
            <h3 className="text-white text-lg font-semibold mb-4 text-center">Filter by Category</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredVehicles.length > 0 ? (
            ...
            <div className="col-span-full text-center py-12">
              <div className="text-white text-xl mb-2">No vehicles found</div>
              <div className="text-white text-opacity-75">
                No vehicles match the selected category "{selectedCategory}"
              </div>
            </div>
          )}
        </div>
